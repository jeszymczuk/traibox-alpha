...
export default function BanksCallbackPage() {
  return (
    <Suspense fallback={<div className="min-h-dvh flex items-center justify-center bg-paper text-ink">Connecting bank…</div>}>
      <BanksCallbackContent />
    </Suspense>
  );
}

function BanksCallbackContent() {
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-paper text-ink">
      <Surface className="w-full max-w-md p-6 space-y-3">
