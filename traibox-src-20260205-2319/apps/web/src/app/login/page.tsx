...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-dvh bg-paper text-ink p-6">
      <div className="max-w-md mx-auto rounded-2xl bg-white shadow-sm border border-black/5 p-6">
          ...
          >
            <label className="block text-sm">
              ...
              <input
                ...
                className="w-full rounded-xl border border-black/10 bg-paper px-3 py-2"
                autoComplete="email"
                required
              />
            </label>

            <button disabled={busy} className="w-full rounded-xl bg-accent text-white px-4 py-2 font-medium disabled:opacity-50" type="submit">
