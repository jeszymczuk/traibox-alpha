...
DIAGNOSIS = OutcomeDefinition(
    ...
    calculations=(
        ...
        RequiredCalculation("cashflow", "capital.calculate_cashflow_timeline", "1.1.0", "cashflow-timeline-v2", _section("cashflow"), evidence_category="cashflow_basis"),
        RequiredCalculation("working_capital", "capital.calculate_working_capital", "1.1.0", "wc-gap-v2", _section("working_capital"), evidence_category="cashflow_basis"),
    ),
...
OPTION_COMPARISON = OutcomeDefinition(
    ...
    calculations=(
        RequiredCalculation("comparison", "capital.compare_financing_options", "1.1.0", "option-comparison-v2", _section("offers"), evidence_category="offer_terms"),
        RequiredCalculation("receivables", "capital.calculate_receivables_finance", "1.1.0", "receivables-proceeds-v2", _section("receivables"), material=False, evidence_category="trade_context"),
    ),
...
FUNDING_PACKET = OutcomeDefinition(
    ...
    calculations=(
        RequiredCalculation("working_capital", "capital.calculate_working_capital", "1.1.0", "wc-gap-v2", _section("working_capital"), evidence_category="cashflow_basis"),
        RequiredCalculation("pnl", "capital.calculate_transaction_pnl", "1.1.0", "pnl-waterfall-v2", _section("pnl"), material=False, evidence_category="cost_evidence"),
        RequiredCalculation("cashflow", "capital.calculate_cashflow_timeline", "1.1.0", "cashflow-timeline-v2", _section("cashflow"), material=False, evidence_category="cashflow_basis"),
        RequiredCalculation("receivables", "capital.calculate_receivables_finance", "1.1.0", "receivables-proceeds-v2", _section("receivables"), material=False, evidence_category="trade_context"),
    ),
...
TERM_SHEET_REVIEW = OutcomeDefinition(
    ...
    required_evidence_categories=("offer_terms",),
    calculations=(
        RequiredCalculation("term_economics", "capital.calculate_financing_cost", "1.1.0", "financing-cost-v2", _section("financing_cost"), evidence_category="offer_terms"),
        RequiredCalculation("comparison", "capital.compare_financing_options", "1.1.0", "option-comparison-v2", _section("offers"), material=False, evidence_category="offer_terms"),
    ),
...
COUNTEROFFER = OutcomeDefinition(
    ...
    required_evidence_categories=("offer_terms",),
    calculations=(
        RequiredCalculation("current_terms", "capital.calculate_financing_cost", "1.1.0", "financing-cost-v2", _section("current_terms"), evidence_category="offer_terms"),
        RequiredCalculation("counter_terms", "capital.calculate_financing_cost", "1.1.0", "financing-cost-v2", _section("counter_terms"), evidence_category="offer_terms"),
    ),
...
TRADE_COST_ANALYSIS = OutcomeDefinition(
    ...
    calculations=(RequiredCalculation("trade_cost", "capital.calculate_trade_cost", "1.0.0", "trade-cost-waterfall-v1", _section("trade_cost"), evidence_category="cost_evidence"),),
...
LANDED_COST_ANALYSIS = OutcomeDefinition(
    ...
    required_authority="analyse",
    required_evidence_categories=("cost_evidence",),
    calculations=(RequiredCalculation("landed_cost", "capital.calculate_landed_cost", "1.0.0", "landed-cost-v1", _section("landed_cost"), evidence_category="cost_evidence"),),
...
PORTFOLIO_PNL = OutcomeDefinition(
    ...
    calculations=(RequiredCalculation("aggregate", "capital.calculate_aggregate_pnl", "1.1.0", "aggregate-pnl-v2", _section("aggregate_pnl"), evidence_category="trade_context"),),
...
CASHFLOW_FORECAST = OutcomeDefinition(
    ...
    calculations=(RequiredCalculation("cashflow", "capital.calculate_cashflow_timeline", "1.1.0", "cashflow-timeline-v2", _section("cashflow"), evidence_category="cashflow_basis"),),
...
TREASURY_LIQUIDITY_PLAN = OutcomeDefinition(
    ...
    calculations=(
        RequiredCalculation("liquidity", "capital.calculate_liquidity_runway", "1.1.0", "runway-v2", _section("liquidity"), evidence_category="liquidity_evidence"),
...
FX_EXPOSURE_ANALYSIS = OutcomeDefinition(
    ...
    calculations=(RequiredCalculation("fx", "capital.calculate_fx_scenarios", "1.1.0", "fx-scenarios-v2", _section("fx"), evidence_category="fx_rate_source"),),
...
CAPITAL_PLAN = OutcomeDefinition(
    ...
    calculations=(
        RequiredCalculation("working_capital", "capital.calculate_working_capital", "1.1.0", "wc-gap-v2", _section("working_capital"), evidence_category="cashflow_basis"),
        RequiredCalculation("liquidity", "capital.calculate_liquidity_runway", "1.1.0", "runway-v2", _section("liquidity"), material=False, evidence_category="liquidity_evidence"),
        RequiredCalculation("investment", "capital.calculate_investment_returns", "1.1.0", "npv-irr-v2", _section("investment"), material=False, evidence_category="scenario_basis"),
    ),
...
SCENARIO_MODEL = OutcomeDefinition(
    ...
    calculations=(
        RequiredCalculation("debt", "capital.calculate_debt_service", "1.1.0", "debt-service-v2", _section("debt"), material=False, evidence_category="scenario_basis"),
        RequiredCalculation("dilution", "capital.calculate_dilution", "1.1.0", "dilution-v2", _section("dilution"), material=False, evidence_category="scenario_basis"),
        RequiredCalculation("investment", "capital.calculate_investment_returns", "1.1.0", "npv-irr-v2", _section("investment"), material=False, evidence_category="scenario_basis"),
    ),
...
INSTRUMENT_BLUEPRINT = OutcomeDefinition(
    ...
    calculations=(
        RequiredCalculation("economics", "capital.calculate_financing_cost", "1.1.0", "financing-cost-v2", _section("financing_cost"), material=False, evidence_category="offer_terms"),
        RequiredCalculation("conditions", "capital.evaluate_conditions", "1.0.0", "condition-eval-v1", _section("conditions"), material=False, evidence_category="condition_evidence"),
    ),
...
MILESTONE_REPORT = OutcomeDefinition(
    ...
    calculations=(RequiredCalculation("conditions", "capital.evaluate_conditions", "1.0.0", "condition-eval-v1", _section("conditions"), evidence_category="condition_evidence"),),
